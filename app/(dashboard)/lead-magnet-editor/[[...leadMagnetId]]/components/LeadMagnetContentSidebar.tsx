...
function LeadMagnetEditorSidebar({
  ...
  return (
    <div
      className="relative flex h-full w-fit flex-col overflow-y-clip border-r border-gray-200 bg-white transition-all duration-300"
    ...
    >
      ...
      >
        ...
        <button
          ...
          className="absolute bottom-4 right-4 text-2xl text-purple-400"
        >
          {isSidebarCollapsed ? (
            <TbLayoutSidebarRightCollapse />
          ) : (
